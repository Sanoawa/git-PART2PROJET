...
<body>
    <div class="container">
        ...
        <form action="co_enfant.php" method="post">
            <label for="nomEnfant">Nom du parent :</label>
            <input type="text" id="nom du parent" name="nom du parent" required><br>

            <label for="prenomEnfant">Prénom du parent :</label>
            ...
            <select id="Nounou " name="TNounou []">
                <option value="Jeanne Elvire">Jeanne Elvire</option>
            </select><br>
